...
public class Thing {
    ...
    static {
        ...
        addAmmo      (2007, "CLIP",  "A",      20, "Ammo Clip");
        addAmmo      (2008, "SHEL",  "A",      20, "Shotgun Shells");
        addAmmo      (2010, "ROCK",  "A",      20, "Rocket");
        addAmmo      (2047, "CELL",  "A",      20, "Cell Charge");
        addAmmo      (2048, "AMMO",  "A",      20, "Box of Ammo");
        addAmmo      (2049, "SBOX",  "A",      20, "Box of Shells");
        addAmmo      (2046, "BROK",  "A",      20, "Box of Rockets");
        addAmmo      (17,   "CELP",  "A",      20, "Cell Charge Pack");
        addAmmo      (8,    "BPAK",  "A",      20, "Backpack");
                                                   
        addHealth    (2011, "STIM",  "A",      20, "Stimpak +10%");
        addHealth    (2012, "MEDI",  "A",      20, "Medikit +25%");
        addHealth    (2014, "BON1",  "ABCDCB", 20, "Health Potion +1%");
        addArmor     (2015, "BON2",  "ABCDCB", 20, "Spirit Armor +1%");
        addArmor     (2018, "ARM1",  "AB",     20, "Green Armor +100%");
        addArmor     (2019, "ARM2",  "AB",     20, "Blue Armor +200%");
        addPowerUp   (83,   "MEGA",  "ABCD",   20, "Megasphere");
        addPowerUp   (2013, "SOUL",  "ABCDCB", 20, "Soulsphere");
        addPowerUp   (2022, "PINV",  "ABCD",   20, "Invulnerability Sphere");
        addPowerUp   (2023, "PSTR",  "A",      20, "Berkserker Pack");
        addPowerUp   (2024, "PINS",  "ABCD",   20, "Invisibility Sphere");
        addPowerUp   (2025, "SUIT",  "A",      20, "Radiation Suit");
        addPowerUp   (2026, "PMAP",  "ABCDCB", 20, "Computer Map");
        addPowerUp   (2045, "PVIS",  "AB",     20, "Light Amplification Goggles");
                                                   
        addKey       (5,    "BKEY",  "AB",     20, "Blue Key");
        addKey       (40,   "BSKU",  "AB",     20, "Blue Skullkey");
        addKey       (13,   "RKEY",  "AB",     20, "Blue Key");
        addKey       (38,   "RSKU",  "AB",     20, "Blue Skullkey");
        addKey       (6,    "YKEY",  "AB",     20, "Blue Key");
        addKey       (39,   "YSKU",  "AB",     20, "Blue Skullkey");
